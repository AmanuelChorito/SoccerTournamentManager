...
exports.listquarterFinal = function () {
  const sql = `SELECT *,(goalfor-goalagainst) as goaldifference FROM players WHERE status='active' and played>=4 ORDER BY groupname, points DESC,(goalfor-goalagainst) DESC`;
